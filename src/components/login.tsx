...
function Login({ loading }: LoginProps): JSX.Element {
  const signIn = () => {
    ...
    <Card>
      {loading ? (
        <button
          disabled
          type="button"
          className="text-white bg-teal-500 hover:bg-teal-700 border-4 border-teal-500 hover:border-teal-700 focus:ring-4 text-sm py-1 px-4 flex-shrink-0 rounded"
        >
          <svg
            role="status"
